			...
			<div class="col-md-2" style="position:absolute; top:30%; transfrom:translate(0%, -30%);">
				...
				<div class="card text-center">
					<div class="card-body">
						...
						<h5 class="card-title" style="font-size: 24px">Singup</h5>
						<form action="singup" method="post">
							<div class="form-group">
			  				...
			  				<div class="form-group">
					    		<label for="user" style="font-size: 18px">Repeat password</label>
	  					...
	  					<form action="/CRUD/login" method="get">
							<div>
		    					<button type="submit" class="btn btn-dark mt-2" aria-pressed="false">Back</button>	
							</div>
						</form>
